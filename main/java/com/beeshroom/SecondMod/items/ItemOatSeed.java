...
public class ItemOatSeed extends Item implements net.minecraftforge.common.IPlantable
{
    private final Block crops;
    /** BlockID of the block the seeds can be planted on. */
    private final Block soilBlockID;

    public ItemOatSeed(Block crops, Block soil)
    {
        this.crops = crops;
        this.soilBlockID = soil;
        this.setCreativeTab(Main.oatmealtab);
    }
